        ...
        api.get("/medicos/mis-disponibilidades")
            ...
            .catch((error) => {
                addToast({
                    ...
                    description: error.message || error.response.data || "Ha ocurrido un error al obtener los horarios.",
                    color: "danger",
        ...
        api.patch(`/medicos/editar-disponibilidades/${id}`, horarios[index])
            ...
            .catch((error) => {
                addToast({
                    ...
                    description: error.response.data.message || "Ha ocurrido un error al actualizar el horario.",
                    color: "danger",
                    shouldShowTimeoutProgress: true,
                    timeout: 5000,
                });
        ...
        api.delete(`/medicos/eliminar-disponibilidad/${horarios[index].id}`)
            ...
            .catch((error) => {
                addToast({
                    ...
                    description: error.message || error.response.data || "Ha ocurrido un error al eliminar el horario.",
                    color: "danger",
                    shouldShowTimeoutProgress: true,
                    timeout: 5000,
                });
        ...
        api.post("/medicos/registrar-disponibilidad", horarios[index])
            ...
            .catch((error) => {
                addToast({
                    ...
                    description: error.response.data.message || "Ha ocurrido un error al guardar el horario.",
                    color: "danger",
                    shouldShowTimeoutProgress: true,
                    timeout: 5000,
                });
            ...
            {isLoadingHorarios ? (
                ...
                horarios.length === 0 ? (
                    ...
                    horarios.map((horario, index) => (
                        ...
                        >
                            <Select
                                isDisabled={horario.id !== 0 ? !isEditando : false}
                                label="Día"
                                color="primary"
