        ...
        <div>
            ...
            <div className='flex flex-col md:flex-row items-center justify-center gap-y-3 md:gap-x-10'>
                ...
                <section className='w-1/2 flex items-center text-center flex-col md:flex-row h-full'>
                    ...
                    <div className="flex flex-col py-10 w-full z-10  items-center text-white">
                        ...
                        <div className="relative w-80 h-[400px] hidden md:flex">
                            <Image
                                src="/banner_medicos.webp"
                                alt="Doctor"
                                fill
                                className="doctors object-contain aspect-square w-auto"
                            />
