...
--
-- Host: localhost    Database: db_citasmed_dev
-- ------------------------------------------------------
...
CREATE TABLE `disponibilidades` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_medico` (`id_medico`),
  CONSTRAINT `disponibilidades_ibfk_1` FOREIGN KEY (`id_medico`) REFERENCES `medicos` (`id`)
...
-- Dump completed on 2025-08-14 21:06:46
